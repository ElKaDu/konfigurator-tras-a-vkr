...
export const AREAS: { id: Area; label: string; description: string; icon: string; enabled: boolean; num: number }[] = [
  { id: "tracking_records", label: "Záznamy z trackingu", description: "Analýza přímo nad tracking záznamy — opakování hodnoty, zaseknutí, opakovaný pokus.", icon: "ListSearch", enabled: false, num: 4 },
